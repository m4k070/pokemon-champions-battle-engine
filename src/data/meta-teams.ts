...
export const META_TEAMS: MetaTeamEntry[] = [
  {
    name: 'Sand Team',
    pokemon: [
      {
        ...
        ability: 'sand-stream',
        item: null,
        baseStats: { HP: 100, ATK: 134, DEF: 110, SPATK: 95, SPDEF: 100, SPEED: 61 },
        moves: [],
      },
      {
        name: 'Excadrill',
  ...
  },
  {
    ...
    pokemon: [
      ...
      },
      {
        ...
        ability: 'swift-swim',
        item: null,
        baseStats: { HP: 61, ATK: 123, DEF: 60, SPATK: 60, SPDEF: 50, SPEED: 136 },
        moves: [],
      },
    ],
  },
